                                ...
                                <div class="row">
                                    <div class="col-md">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-md">
                                                <h4 class="fw-semibold" id="ticket-title">KUMPULAN BERITA DAN ARTIKEL
                                                </h4>
                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            ...
                            <p class="text-muted">It would also help to know what the errors are - it could be something
                                simple like
                                a message saying delivery is not available which could be a problem with your shipping
                                templates.
                                Too much or too little spacing, as in the example below, can make things unpleasant for
                                the reader.
                                The goal is to make your text as comfortable to read as possible. On the note of
                                consistency, color
                                consistency is a MUST. If you’re not trying to create crazy contrast in your design,
                                then a great
                                idea would be for you to use a color palette throughout your entire design. It will
                                subconsciously
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="text-muted">Your <a href="javascript:void(0)"
                                            ...
                                            with the
                                            most current status of your order. To help manage your order refer to the
                                            “Action Menu”
