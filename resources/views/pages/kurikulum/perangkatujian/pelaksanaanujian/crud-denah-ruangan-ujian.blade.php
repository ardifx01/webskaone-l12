        ...
        <div class="card-header">
            <div class="d-flex align-items-center">
                ...
                <div class="flex-shrink-0 me-2">
                    <x-btn-tambah can="create kurikulum/perangkatujian/pelaksanaan-ujian/denah-ruangan-ujian"
                        route="kurikulum.perangkatujian.pelaksanaan-ujian.denah-ruangan-ujian.create" icon="ri-add-line" />
                </div>
