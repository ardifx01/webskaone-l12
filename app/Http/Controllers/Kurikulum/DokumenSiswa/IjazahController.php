...
class IjazahController extends Controller
{
    ...
    public function showSuratKetLulus($nis)
    {
        $dataRombel = PesertaDidikRombel::where('nis', $nis)->first();
        ...
        return view('pages.kurikulum.dokumensiswa.ijazah-skkl-tampil', [
            'dataRombel' => $dataRombel,
            'kelulusan' => $kelulusan,
            'datasiswalulus' => $datasiswalulus,
            'dataSiswa' => $dataSiswa,
    ...
    public function showSuratKetBaik($nis)
    {
        $dataRombel = PesertaDidikRombel::where('nis', $nis)->first();
        ...
        return view('pages.kurikulum.dokumensiswa.ijazah-skkb-tampil', [
            'dataRombel' => $dataRombel,
            'kelulusan' => $kelulusan,
            'datasiswalulus' => $datasiswalulus,
            'dataSiswa' => $dataSiswa,
